...
@section('head-after')
	<link media="all" type="text/css" rel="stylesheet" href="/assets/themes/demo/vendor/img-comparison-slider/img-comparison-slider.css">
@endsection
...
@section('scripts-after')
	@parent
	<script src="/assets/themes/demo/vendor/img-comparison-slider/img-comparison-slider.js"></script>
@endsection